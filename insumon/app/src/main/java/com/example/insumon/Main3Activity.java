...
public class Main3Activity extends AppCompatActivity {
    ...
    private Transfer transfer = MainActivity.transfer;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_dashboard:
                    Intent a = new Intent(Main3Activity.this,Act1.class);
                    startActivity(a);
                    //MainActivity.this.finish();
                    break;
                case R.id.navigation_notifications:
                    Intent b = new Intent(Main3Activity.this,Act2.class);
                    startActivity(b);
                    //MainActivity.this.finish();
                    break;
            }
...
//        transfer=(Transfer) getIntent().getSerializableExtra("Transfer");
        ...
        ArrayAdapter<String> lunchList = new ArrayAdapter<>(Main3Activity.this,
...
//                mDisplayDate.setText(str);
                ...
                DatePickerDialog dialog= new DatePickerDialog(Main3Activity.this,
        ...
        mDisplayTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog dialog= new TimePickerDialog(Main3Activity.this,
