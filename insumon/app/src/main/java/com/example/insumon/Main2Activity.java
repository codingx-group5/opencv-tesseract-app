...
public class Main2Activity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_dashboard:
                    Intent a = new Intent(Main2Activity.this,Act1.class);
                    startActivity(a);
                    //MainActivity.this.finish();
                    break;
                case R.id.navigation_notifications:
                    Intent b = new Intent(Main2Activity.this,Act2.class);
                    startActivity(b);
                    //MainActivity.this.finish();
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("dit", String.valueOf(getFilesDir()));


//        transfer=(Transfer) getIntent().getSerializableExtra("Transfer");
        Log.d("transferType", String.valueOf(transfer.getClass()));
